...
struct motocrossRacingView: View {
    @StateObject private var eventData = EventDataMotocrossRacing()

    var body: some View {
        VStack {
//            Text("motocrossRacing")
//                .font(.headline)
//                .padding()

            List(eventData.motocrossRacingActivities) { activity in
